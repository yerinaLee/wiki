...
**한줄요약** Java로 프로그래밍을 해야함 : JDK Java 프로그램을 실행시켜야함 : JRE

![](<../.gitbook/assets/Pasted image 20260306132700.png>) ![](<../.gitbook/assets/Pasted image 20260306132712.png>)
...
**특징** -- JDK는 종류가 여러가지 있음 -- java의 소스코드는 오픈소스지만, JDK 라이센스가 유료가 될 수 있어 여러 JDK버전이 출시됨(linux와 비슷)
...
1. Java Compiler가 .java파일을 .class파일로 Byte Code 컴파일 (OS 이전에 JVM이 이해하는 코드) .java => .class
